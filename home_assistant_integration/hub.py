...
class Hub:
    ...
    def __init__(self, hass: HomeAssistant, host: str) -> None:
        ...
        self._id = host.lower()
        self.feeders = [
            PetFeeder(f"{self._id}_1", f"{self._name} 1", self),
            PetFeeder(f"{self._id}_2", f"{self._name} 2", self),
            PetFeeder(f"{self._id}_3", f"{self._name} 3", self),
        ]
        self.online = True
